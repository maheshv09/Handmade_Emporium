...
const Navbar = () => {
  ...
  <div className="container-fluid">
    <Link className="navbar-brand mx-4" to="/"><strong>ARTIFY</strong></Link>
    ...
    <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
      ...
      <form class="d-flex ms-auto" role="search">
        ...
        <Link to='/cart' className="btn btn-outline-light mx-2" ><i className="fa-lg"><FontAwesomeIcon icon={faCartShopping} /></i></Link>
      </form>
    </div>
  </div>
</nav>
